...
// console.log(nuestroTitulo.innerText); //obtiene solo el texto
// nuestroTitulo.innerText = 'Este es otro texto'; //cambia el texto
...
//     mediaLinks[i].innerText = 'Probandooooooooo';
// }
...
/*`El promedio es ${calcularPromedio(numerosArray)}`
...
// ***diferencia entre textcontent y innertext:
// textcontent te da todo el texto 
// innertext te da solo el contenido visible 
...
// const titulo = document.querySelector('h1');
// titulo.textContent = 'Este es el titulo nuevo!';
...
/*
   Creando nuevos nodos (Elementos)
    ...
    const nodoPagina = document.querySelector('body'); // Toma el body: <body>............</body>
    const nuevoParrafo = document.createElement('p'); // Crea un p: <p></p>
    const textoParrafo = document.createTextNode('Siiiiiii!'); // Crea el texto 'Siiiiii'
    nuevoParrafo.appendChild(textoParrafo); // Inserta el texto en el p: <p>Siiiiii</p>
    nodoPagina.appendChild(nuevoParrafo); Inserta p en el body: <body><p>Siiiiiiii</p><body>
*/
...
// imagenHeader.setAttribute('src', 'https://cf.ltkcdn.net/gatos/images/std/236641-699x450-etapas-desarrollo-gatitos.jpg');
// imagenHeader.style.width = '300px';
