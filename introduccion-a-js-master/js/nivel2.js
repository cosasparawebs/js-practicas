...
// let comidasFavoritas = ['pastel de papas', 'hamburguesas', 'milanesas', 'polenta con chorizo', 'panchos'];
...
// no se puede cambiarlo totalmente mientras es const ********
...
//     // totalNotas += notas[i]; esto es lo mismo que lo de abajo
...
// let notasTest = [8, 8, 6, 7, 5];
// let sumaNotas = 0;

// function calcularPromedio(notasTest){

//     for(i = 0; i < notasTest.length; i++){
//         sumaNotas += notasTest[i]
//     }
//     return sumaNotas / notasTest.length;
// }
// console.log(calcularPromedio(notasTest));
...
//     console.log('Mis comidas favoritas son: ' + comidasFavoritas[i]); 
// }
