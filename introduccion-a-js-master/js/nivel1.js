...
// let miEdad = restar(anioActual, anioNacimiento); //es la funcion restar de arriba
...
//crear una funcion que tome como parametro el anio actual y ani de naciomiento y calcule la edad del usuario, estas valiables tienen que ser dadas por datos que ingrese el usuario, y que impriman el resultado en la  consola
...
//     return numero1 - numero2;
// }
// console.log('Tu edad es: ' + calcularEdad(anioActual, anioUsuario));

// preguntar el salario anual y calcular el mensual

// let salarioAnual = parseInt(prompt('Ingresa tu salario anual'));

// function salarioMensual(numero){
//     return numero / 12;
// }
// console.log('Tu salario mensual es: ' + salarioMensual(salarioAnual))

// preguntar el salario mensual y calcular el anual

// let salarioMensual = parseInt(prompt('Ingresa tu salario mensual'));

// function salarioAnual(numero){
//     return numero * 12;
// }
// console.log('Tu salario anual es: ' + salarioAnual(salarioMensual));
...
// TAREA: usando el operador !, Inconsole.log(!elBajoEsLoMejor);tentá invertir una variable (de true a false, o de false a true) e imprimí el
// resultado en la consola.

// let elBajoEsLoMejor = true;
// console.log(!elBajoEsLoMejor);
// console.log(!!elBajoEsLoMejor);
