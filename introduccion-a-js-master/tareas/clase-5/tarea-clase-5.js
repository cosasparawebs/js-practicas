...
boton.addEventListener('click', function(){
  let inputAnual = document.getElementById('salarioAnual').value;
  let inputMensual = document.getElementById('salario-mensual');

  function calcularSalarioMensual(inputAnual){
    return inputAnual / 12;
  }

  inputMensual.value = calcularSalarioMensual(inputAnual);
})
